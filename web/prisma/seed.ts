...
async function main() {
  // If DB already has data, don't overwrite.
      ...
      chordSheets: {
        create: [
          ...
          },
          {
            section: "chorus",
            instrumentType: "guitar",
            lyricsWithChords: "[A]Holy, there is no one like You\n[E]There is none beside You",
          },
          {
            section: "chorus",
            instrumentType: "bass",
    ...
    create: {
      ...
      songs: {
        create: [
          ...
          { songId: "seed-song-2", order: 1, selectedKey: "Bb", notes: "Capo 3 to match recording; repeat chorus 2x at end" },
        ],
      },
    },
  });

  console.log("Seed OK — users: admin@church.local, leader@church.local, musician@church.local, singer@church.local / password123");
}
